...
class UiController(UiControllerBase):
    ...
    def cFlagAddClicked(self, signal: 'bool'):
        '''Signal handler from widget 'cflagsAddBtn'
        connecting signal 'clicked['bool']'.
        
        '''

        print(signal)
    
    def cFlagRemovedClicked(self, signal: 'bool'):
    ...
    def outfileBrowseBtnClicked(self, signal: 'bool'):
    ...
    def compileClicked(self, signal: 'bool'):
    ...
    def executeClicked(self, signal: 'bool'):
    ...
    def runLastClicked(self, signal: 'bool'):
    ...
    def sourceBrowseBtnClicked(self, signal: 'bool'):
    ...
    def generateMakefileClicked(self, signal: 'bool'):
    ...
    def makefileSaveClicked(self, signal: 'bool'):
    ...
    def makefileSaveAsClicked(self, signal: 'bool'):
    ...
    def makefileOpenClicked(self, signal: 'bool'):
    ...
    def runMakefileClicked(self, signal: 'bool'):
    ...
    def makefileDoUseClicked(self, signal: 'bool'):
