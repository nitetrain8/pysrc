...
class UiController(UiControllerBase):
    ...
    def cFlagAddClicked(self, signal: 'int'):
    ...
    def cFlagRemovedClicked(self, signal: 'int'):
    ...
    def outfileBrowseBtnClicked(self, signal: 'int'):
    ...
    def outfileEditReturnPressed(self, signal: 'int'):
    ...
    def compileClicked(self, signal: 'int'):
    ...
    def executeClicked(self, signal: 'int'):
    ...
    def runLastClicked(self, signal: 'int'):
    ...
    def sourceBrowseBtnClicked(self, signal: 'int'):
    ...
    def generateMakefileClicked(self, signal: 'int'):
    ...
    def makefileSaveClicked(self, signal: 'int'):
    ...
    def makefileSaveAsClicked(self, signal: 'int'):
    ...
    def makefileOpenClicked(self, signal: 'int'):
    ...
    def runMakefileClicked(self, signal: 'int'):
    ...
    def makefileDoUseClicked(self, signal: 'int'):
